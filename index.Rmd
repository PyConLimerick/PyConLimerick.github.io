...
<h5> Tailoring Scripts to Fit (Gary Chadwick)</h5>
...
For example, we have a render farm that exports scenes for our animators. But because we know exactly where we store our files and the format they're in, we can also automatically upload those videos to our online production tracking system. My talk would explain this approach, how to write code in neat functions that can be broadly reusable.
...
<h5> Parallelism and concurrency (Urja Pawar)	</h5>
<p>
<hline>
...
<h5>Visualising Youtube video context (Krunoslav Plecko)</h5>
